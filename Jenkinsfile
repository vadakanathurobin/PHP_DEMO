...
// } 
    ...
    steps{
        script{
            ...
            sshagent(['DEV_SERVER']) {
    sh "ssh -o StrictHostKeyChecking=no ${ACM_IP} envsubst \$IMAGE_NAME < ansible/docker-compose-var.yml > ansible/docker-compose.yml" 
